/* Banco de PARSING ASCENDENTE (Práctica 3).
   ...
   `etapas` descompone el ejercicio como lo hace la cátedra: primero la gramática aumentada,
   después los conjuntos, después la tabla. Los ejercicios chicos piden la tabla completa;
   los de gramáticas grandes se quedan en los conjuntos, porque la tabla pasa de 200 celdas. */
...
export const PARSING_EJ: EjercicioParsing[] = [
  {
    ...
    gramatica: 'A -> id := E\nE -> E + T | T\nT -> T * F | F\nF -> id | cte',
    etapas: ['aumentada', 'primeros', 'siguientes', 'tabla']
  },
  {
  ...
  },
  {
    ...
    etapas: ['aumentada', 'primeros', 'siguientes']
  },
  {
  ...
  },
  {
    ...
    etapas: ['aumentada', 'primeros', 'siguientes', 'tabla', 'conflictos']
  },
  {
